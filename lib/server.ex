...
#   def send_sms_with_messaging_service(phone_numbers, body, messaging_sid, status_callback, account, token) do
#     GenServer.cast(__MODULE__, {:send_sms_with_messaging_service, phone_numbers, body, messaging_sid, status_callback, account, token})
#   end
...
#   def handle_cast({:send_sms_with_messaging_service, phone_numbers, body, messaging_sid, status_callback, account, token}, state) do
#     Sms.send_sms_with_messaging_service(phone_numbers, body, messaging_sid, status_callback, account, token)
#     {:noreply, state}
#   end
