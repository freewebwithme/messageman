defmodule Messageman.Sms do
	...
	"""
	@spec send_sms(list, String.t, String.t) :: map
	...
	"""
	@spec send_sms_with_messaging_service(list, String.t, String.t) :: map
	def send_sms_with_messaging_service(phone_numbers, body, messaging_service_sid) do
		{account, token} = Config.get_credential_info()
		phone_numbers
